...
public class TrajectoryPredictor : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        SetTrajectoryVisible(true);      //Simplemente activa el lineRenderer y el hitMarker
    }
    ...
    public void PredictTrajectory(ProjectileProperties projectile)
    {
        ...
        for (int i = 1; i < maxPoints; i++)
        {
            ...
            if (Physics.Raycast(position, velocity.normalized, out RaycastHit hit, overlap,hitLayers))
            {
